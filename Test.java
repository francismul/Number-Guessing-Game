        ...
        try (Scanner scanner = new Scanner(System.in)) {
            ...
            while (true) {
                ...
                try {
                    ...
                    System.out.println("Debug: User choice is " + choice);

                    switch (choice) {
                        case 1 -> {
                            int trials = 0;
                            int randomNumber = generateRandomNumber();
                            System.out.println("Debug: Generated random number is " + randomNumber);
                            ...
                            while (trials < 3) {
                                try {
                                    ...
                                    trials++;
                                    System.out.println("Debug: Number of trials is " + trials);
